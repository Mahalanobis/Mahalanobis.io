...
Recentemente ho avuto il piacere di tenere una conferenza didattica nell'ambito del corso "_Analisi dei dati (data mining)_", tenuto dal prof. [Bruno Scarpa](https://homes.stat.unipd.it/brunoscarpa/), presso il [Dipartimento di Scienze Statistiche](https://www.stat.unipd.it/) a Padova. 

L'intervento verteva sull'evoluzione che negli ultimi anni ha avuto l'**Intelligenza Artificiale (AI)** nell'ambito del [NLP](https://en.wikipedia.org/wiki/Natural_language_processing), _un percorso affascinante che ci ha portato dalle rappresentazioni lessicali come il Bag of Words alle architetture neurali avanzate basate sui Transformer_.
